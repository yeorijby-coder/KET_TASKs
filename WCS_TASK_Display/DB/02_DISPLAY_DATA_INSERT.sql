...
--              CNT       = 2      -> 전광판 2대 (DSP_NO = 1, 2)
--              FR_TRACK  = 2006   -> DSP_NO 1
--              TO_TRACK  = 2012   -> DSP_NO 2
...
-- [확인] 등록 상태
-- SELECT WH_TYP, PLC_NO, DSP_NO, TRACK_NO, DISP_DATA, LUGG_NO, COLOR,
--        CMD_RQ_YN, SEND_YN, LAST_SENT_DATA, SEND_DT
--   FROM DISPLAY_DATA
--  ORDER BY WH_TYP, PLC_NO, DSP_NO;
...
--  WHERE WH_TYP = '10' AND PLC_NO = '01' AND DSP_NO = '1';
