...
namespace TSK_COMM_IOSCH
{
    ...
    public class cTitleBar
    {
        ...
        {
#if ORACLE
            return "[DB(Oracle) : " + cDefApp.GM_DB_ALIAS + "@" + cDefApp.GM_DB_USERID + "]";
#elif POSTGRESQL
            return "[DB(PostgreSQL) : " + cDefApp.GM_PDB_DATABASE + "@" + cDefApp.GM_PDB_USER
                                        + "/" + cDefApp.GM_PDB_IP + ":" + cDefApp.GM_PDB_PORT + "]";
#elif SQL
            return "[DB(MS-SQL) : " + cDefApp.GM_PDB_DATABASE + "@" + cDefApp.GM_PDB_USER
                                    + "/" + cDefApp.GM_PDB_IP + ":" + cDefApp.GM_PDB_PORT + "]";
#else
            return "[DB(None)]";
#endif
